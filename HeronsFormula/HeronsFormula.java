public class HeronsFormula
{
	public static void main( String [] args )
	{
		...
		System.out.println("A triangle with sides 8, 15, 17 has an area of " + triangleArea(5, 12, 13) );
		System.out.println("A triangle with sides 9, 9, 9 has an area of " + triangleArea(9, 9, 9) );
	}
	
	public static double triangleArea( int a, int b, int c )
	{
		//the code in this function computes the area of a triangle whose sides have lengths
		double s, A;
